	...
	int cmdShow)
{
	...
	LPCSTR texturesToUse[] = { "Images\\Fox1.png", "Images\\Fox2.png", "Images\\Fox3.png", "Images\\Fox4.png", "Images\\Acorn.png" };
	...
	LPCSTR bkgTexturesToUse[] = { "Images/Background1.png", "Images/Background2.png", "Images/Background3.png" };
	...
	// load game sounds
	// Load Sound
	LPCSTR gameSounds[3] = { "Audio/Theme.mp3", "Audio/Shoot.wav", "Audio/Score.wav" };
	// first [0] is background theme
	theSoundMgr->add("Theme", gameSounds[0]);
	theSoundMgr->add("Shot", gameSounds[1]);
	theSoundMgr->add("Score", gameSounds[2]);
	...
	cTexture rocketTxt;
	rocketTxt.createTexture("Images\\Squirrel2.png");
	...
	// Attach sound manager to squirrel sprite
	...
	string outputMsg;
	string strMsg[] = { "A = Left, D = Right, Space = Shoot","Shoot the targets", "Squirrel Attack","Thanks for playing!" };
	...
	while (pgmWNDMgr->isWNDRunning())
	{
		...
		case MENU:
			...
			// displays name of game and instructions
			outputMsg = strMsg[2];
		...
		case PLAYING:
			...
			spriteBkgd.render();
			{
				//create foxes on screen 
				vector<cAsteroid*>::iterator asteroidIterator = theAsteroids.begin();
				while (asteroidIterator != theAsteroids.end())
				{
					if ((*asteroidIterator)->isActive() == false)
					{
						//destroy fox sprite and increase score by 1.
			...
			theFontMgr->getFont("Funk")->printText("Squirrel Attck", FTPoint(800.0f, 750.0f, 0.0f));
